...
const queue1 = "updateTruck";
const queue2 = "createTruck";
const queue3 = "blockTruckById";
const queue4 = "unBlockTruckById";
const queue5 = "unVerifyTruckById";
const queue6 = "verifyTruckById";
